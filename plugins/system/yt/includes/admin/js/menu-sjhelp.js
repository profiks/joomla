jQuery(document).ready(function($){
	if($('#module-menu')!=null){
		...
		$('#menu li#li-sjhelp').append('<a class=\'dropdown-toggle\' data-toggle=\'dropdown\' href=\'#\' style=\'background: url(../plugins/system/yt/includes/admin/images/yt.png) no-repeat 5px center; cursor:pointer; padding-left:25px\'>SJ Help</a>');
		...
		$('.yt-clearcache').append('<a style=\'background: url(../plugins/system/yt/includes/admin/images/clean-cache.png) no-repeat left center; cursor:pointer; padding-left:15px;\' href=\'javascript:void(0)\'>Clean cache: CSS, JS</a>');
