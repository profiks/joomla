...
JHtml::stylesheet('templates/'.JFactory::getApplication()->getTemplate().'/html/'.$module->module.'/assets/css/slider.css');
	...
	<div id="<?php echo $tag_id; ?>" class="sj-k2-container-slider" style="<?php if( $options->anchor == "bottom" ){ echo "margin-bottom:40px;"; }?>">
			...
			<div class="page-button <?php echo $options->anchor;?> <?php echo $options->control;?>">
				<ul class="control-button preload">
					<li class="bt-slider preview"></li>
					<li class="bt-slider next"></li>
				</ul>		
			</div>
			<?php }}?>
							...
							<?php 
								...
								if((is_file($img) && file_exists($img)) || SjK2SliderHelper::isUrl($img)){
									...
									<div class="item-img item-height">
										...
										if( $extra_link !="" ){
										?>									
											<a href="<?php echo $extra_link[1] ?>" target="<?php echo $extra_link[2] ?>">
    ...
    jQuery(document).ready(function($){
		;(function(element){
			...
			$('.slider', $element).responsiver({
				...
				control:{
					prev: '#<?php echo $tag_id;?> .control-button li[class="bt-slider preview"]',
					next: '#<?php echo $tag_id;?> .control-button li[class="bt-slider next"]'
				},
