...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php if($key % 2 == 0){echo 'col-left';}else{echo 'col-right';}?>">
			...
			<?php if($params->get('itemImage')): ?>
				  <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
					<?php 
						...
						$imgsrc= isset($item->image) ?  isset($item->image) : '';
						if ( $imgsrc == '' && $params->get('imgcfg_placeholder')==1){
							 $imgsrc = $params->get('imgcfg_placeholder_path');
						}
						
					?>
					<img src="<?php echo $imgsrc; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
					
				  </a>
			<?php endif; ?>
		  
		  <?php if($params->get('itemTitle')): ?>
				<div class="item-title"><a href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a></div>
		  <?php endif; ?>
		   <?php if($params->get('itemDateCreated')): ?>
				<div class="item-post-read"><?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC3')); ?></div>
		  <?php endif; ?>
