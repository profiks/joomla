...
<div id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="latestItemsContainer" >
		...
		<div class="latestItemsCategory">
			...
			<div class="latestItemsCategoryImage pull-left">
		...
		<!-- Start Items list -->
		<div class="catItemList row-fluid">
		...
		<?php else: ?>
            ...
            <?php
                $inumber = $this->params->get('latestItemsCols');
                if($i< $inumber) $i++;
                elseif ($i== $inumber) $i=1;
            ?>
			
            <div class="catItemView span<?php echo round((12 / $this->params->get('latestItemsCols')));?> <?php  echo'item'.$i;?>">
                <?php $this->item=$item; echo $this->loadTemplate('item'); ?>
            </div>
			<?php endforeach; ?>
