...
// BEGIN: get param in template SJ
if($app->getTemplate(true)->params->get('k2listing_special', 0)==0){
...
<div id="k2Container" class="clearfix itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
				<div class="subCategory">
					...
					<h2>
                        ...
                        <span class="number"><?php if($this->params->get('subCatTitleItemCounter')) echo ' '.$subCategory->numOfItems.''; ?> </span>
					</h2>
					<?php endif; ?>
					...
					<!-- Subcategory more... -->
					<a class="btn" href="<?php echo $subCategory->link; ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading"  class="row-fluid">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo round((12 / $this->params->get('num_leading_columns')));?>" >
				<?php
		...
		<div id="itemListPrimary" class="row-fluid" >
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo round((12 / $this->params->get('num_primary_columns')));?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
					echo $this->loadTemplate('item');
		...
		<div id="itemListSecondary" class=" row-fluid">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> span<?php echo round((12 / $this->params->get('num_secondary_columns')));?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
					echo $this->loadTemplate('item');
